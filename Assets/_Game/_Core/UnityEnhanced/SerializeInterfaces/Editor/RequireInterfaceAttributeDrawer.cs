...
namespace UnityEnhanced.SerializeInterfaces.Editor
{
	...
	{
		RequireInterfaceAttribute _requireInterfaceAttribute => (RequireInterfaceAttribute)attribute;

		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			InterfaceObjectArguments args = new(GetTypeOrElementType(fieldInfo.FieldType), _requireInterfaceAttribute.InterfaceType);
