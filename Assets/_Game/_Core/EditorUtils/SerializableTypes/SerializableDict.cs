...
/// </summary>
[Serializable]
public class SerializableDict<TKey, TValue> : IDictionary<TKey, TValue>, ISerializationCallbackReceiver
{
    // Internal
    [SerializeField] List<KeyValuePair> list = new();
    [SerializeField, HideInInspector] Dictionary<TKey, int> indexByKey = new();
    [SerializeField, HideInInspector] Dictionary<TKey, TValue> dict = new();
